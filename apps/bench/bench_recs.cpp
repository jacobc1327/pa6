...
const GBenchmark::Factory gBenchFactories[] {
    ...
    []() -> GBenchmark* { return new RectsBench(false, true); },
    []() -> GBenchmark* { return new RectsBench(true,  true);  },
    []() -> GBenchmark* { return new RectsBench(false, false); },
    []() -> GBenchmark* { return new RectsBench(true,  false);  },
    []() -> GBenchmark* {
    ...
    []() -> GBenchmark* { return new BitmapBench("apps/spock.png", "bitmap_mirror",
                                                 GTileMode::kMirror); },
    []() -> GBenchmark* { return new ModAlphaBench(0, "mod_alpha_0"); },
    []() -> GBenchmark* { return new ModAlphaBench(1, "mod_alpha_1"); },
    []() -> GBenchmark* { return new ModAlphaBench(0.5, "mod_alpha_0.5"); },
